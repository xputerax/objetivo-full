...
<html lang="en">
    <head>
        ...
        />
        <link
            href="{{ asset('vendor/quill/quill.snow.css') }}"
            rel="stylesheet"
        />
        <link
            href="{{ asset('vendor/quill/quill.bubble.css') }}"
            rel="stylesheet"
        />
        <link
        ...
        />
        <link
            href="{{ asset('vendor/simple-datatables/style.css') }}"
            rel="stylesheet"
        />
    ...
    <body>
        ...
        <script src="{{
                asset('vendor/simple-datatables/simple-datatables.js')
            }}"></script>
